...
La clase "Departamento" se le agregó una lista para almacenar los empleados que pertenecen a él, además de 2 métodos para agregar y eliminar elementos de esta lista.